...
public class TeacherTimeTableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.menu_home_btn).setOnClickListener(v->{
            startActivity(new Intent(TeacherTimeTableActivity.this, TeacherHomeActivity.class));
        });

        findViewById(R.id.menu_profile_btn).setOnClickListener(v->{
            startActivity(new Intent(TeacherTimeTableActivity.this, TeacherProfileActivity.class));
        });
    }
}